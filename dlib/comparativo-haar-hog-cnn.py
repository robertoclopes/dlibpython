...
fonte = cv2.FONT_HERSHEY_COMPLEX_SMALL  #fonte para identificar classificadores
...
#classificador Haar
detectorHaar = cv2.CascadeClassifier("recursos/haarcascade_frontalface_default.xml")    #importa o classificador treinado
imagemCinza = cv2.cvtColor(imagem, cv2.COLOR_BGR2GRAY)  #transforma em escala de cinza a imagem
facesDetectadasHaar = detectorHaar.detectMultiScale(imagemCinza, scaleFactor=1.1, minSize=(10,10))  #variavel para armazenanr os bounding boxes
...
for (x, y, l, a) in facesDetectadasHaar:
    cv2.rectangle(imagem, (x, y), (x + l, y + a), (0, 255, 0), 2)   #desenha retangulo
    cv2.putText(imagem, "Haar", (x, y - 5), fonte, 0.5, (0, 255, 0))    #imprime classificador na posicao indicada
